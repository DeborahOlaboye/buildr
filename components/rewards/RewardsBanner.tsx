...
export default function RewardsBanner({ program }: RewardsBannerProps) {
  return (
    <section
      aria-label={`${program.name} reward program`}
      className="relative overflow-hidden rounded-2xl border bg-gradient-to-br from-orange-50 to-purple-50 dark:from-orange-950/30 dark:to-purple-950/30 p-6 sm:p-8"
    >
