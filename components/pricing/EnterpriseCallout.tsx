  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border bg-gradient-to-br from-muted/60 to-muted/20 p-8 text-center space-y-4">
      ...
      <div className="relative">
        <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-primary/10 mx-auto mb-3" aria-hidden="true">
        ...
        <Button className="mt-5 gap-2" asChild>
          <a
            ...
            aria-label={`Contact our team at ${SUPPORT_EMAIL}`}
          >
            Contact our team
